...
307	Cow	\N	\N	Least Concern
308	Rhino	Ill	New born	Endangered
\.
...
SELECT pg_catalog.setval('animals_id_seq', 308, true);
...
COPY sightings (id, rangername, location, timespotted, animalid) FROM stdin;
\.
